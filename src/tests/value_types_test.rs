...
fn test_replace_bool_value_true_variants() {
    let test_cases = vec!["true", "True", "TRUE", "t", "T", "1", "yes", "YES", "y", "Y"];
...
fn test_replace_bool_value_false_variants() {
    let test_cases = vec!["false", "False", "FALSE", "f", "F", "0", "no", "NO", "n", "N"];
...
fn test_value_equality_same_type() {
    assert_eq!(Value::Str("test".to_string()), Value::Str("test".to_string()));
...
fn test_value_inequality_different_values() {
    assert_ne!(Value::Str("test".to_string()), Value::Str("other".to_string()));
...
#[test]
fn test_value_clone() {
    let val1 = Value::Str("test".to_string());
    let val2 = val1.clone();
